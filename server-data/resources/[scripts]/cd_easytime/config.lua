...
Config.Command = 'time' --Customise the command name to open the UI.
...
Config.SnowChance = 25 --The percent chance for it to snow out of 100.
Config.ThunderChance = 50 --The percent chance for it to thunder when raining out of 100.
