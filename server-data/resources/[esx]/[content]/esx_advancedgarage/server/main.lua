	...
	if job == 'ambulance' then
		if type == 'both' then
			if attempt == 'check' then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_paid') .. Config.Ambulance.PoundP})
	...
	elseif job == 'police' then
		if type == 'both' then
			if attempt == 'check' then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_paid') .. Config.Police.PoundP})
	...
	elseif job == 'mechanic' then
		if type == 'both' then
			if attempt == 'check' then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_paid') .. Config.Mechanic.PoundP})
	...
	elseif job == 'civ' then
		if type == 'aircrafts' then
			if attempt == 'check' then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_paid') .. Config.Aircrafts.PoundP})
		...
		elseif type == 'boats' then
			if attempt == 'check' then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_paid') .. Config.Boats.PoundP})
		...
		elseif type == 'cars' then
			if attempt == 'check' then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_paid') .. Config.Cars.PoundP})
...
AddEventHandler('esx_advancedgarage:payhealth', function(price)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_paid') .. price})
