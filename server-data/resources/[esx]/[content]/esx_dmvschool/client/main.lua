...
function StopTheoryTest(success)
	...
	if success then
		...
		exports['mythic_notify']:SendAlert('Inform', _U('passed_test'))
		--ESX.ShowNotification(_U('passed_test'))
	else
	exports['mythic_notify']:SendAlert('Inform', _U('failed_test'))
	...
	while true do
		...
		if CurrentTest == 'drive' then
			...
			if Config.CheckPoints[nextCheckPoint] == nil then
				...
				CurrentTest = nil
exports['mythic_notify']:SendAlert('Inform', _U('driving_test_complete'))
...
exports['mythic_notify']:SendAlert('Inform', _U('driving_too_fast'))
							--ESX.ShowNotification(_U('driving_too_fast', v))
							exports['mythic_notify']:SendAlert('Inform', _U('errors'))
				...
				if health < LastVehicleHealth then
					...
					DriveErrors = DriveErrors + 1
exports['mythic_notify']:SendAlert('Inform', _U('you_damaged_veh'))
					--ESX.ShowNotification(_U('you_damaged_veh')),
					exports['mythic_notify']:SendAlert('Inform', _U('errors', DriveErrors, Config.MaxErrors))
					--ESX.ShowNotification(_U('errors', DriveErrors, Config.MaxErrors))
