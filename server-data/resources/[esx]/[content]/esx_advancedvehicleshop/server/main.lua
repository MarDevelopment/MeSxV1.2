...
ESX.RegisterServerCallback('esx_advancedvehicleshop:buyVehicleAJ', function(source, cb, model, plate, name)
	...
	if modelPrice and xPlayer.getMoney() >= modelPrice then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert',{ type = 'inform', text = _U('ambulance_belongs', plate )})
...
ESX.RegisterServerCallback('esx_advancedvehicleshop:buyVehiclePJ', function(source, cb, model, plate, name)
	...
	if modelPrice and xPlayer.getMoney() >= modelPrice then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert',{ type = 'inform', text = _U('police_belongs', plate )})
	...
	if modelPrice and xPlayer.getMoney() >= modelPrice then
		...
		if xPlayer.job.name == 'ambulance' then
			if model == Config.Division.Heli1 then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', { type = 'inform', text = _U('division_belongs', plate )})
...
ESX.RegisterServerCallback('esx_advancedvehicleshop:buyVehicleMJ', function(source, cb, model, plate, name)
	...
	if modelPrice and xPlayer.getMoney() >= modelPrice then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', { type = 'inform', text = _U('mechanic_belongs', plate )})
...
ESX.RegisterServerCallback('esx_advancedvehicleshop:buyVehicleA', function(source, cb, model, plate, category, name)
	...
	if modelPrice and xPlayer.getMoney() >= modelPrice then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', { type = 'inform', text = _U('aircraft_belongs', plate )})
...
ESX.RegisterServerCallback('esx_advancedvehicleshop:buyVehicleB', function(source, cb, model, plate, category, name)
	...
	if modelPrice and xPlayer.getMoney() >= modelPrice then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', { type = 'inform', text = _U('boat_belongs', plate )})
...
ESX.RegisterServerCallback('esx_advancedvehicleshop:buyVehicleC', function(source, cb, model, plate, category, name)
	...
	if modelPrice and xPlayer.getMoney() >= modelPrice then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', { type = 'inform', text = _U('car_belongs', plate )})
...
ESX.RegisterServerCallback('esx_advancedvehicleshop:buyVehicleT', function(source, cb, model, plate, category, name)
	...
	if modelPrice and xPlayer.getMoney() >= modelPrice then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', { type = 'inform', text = _U('truck_belongs', plate )})
...
ESX.RegisterServerCallback('esx_advancedvehicleshop:buyVehicleV', function(source, cb, model, plate, category, name)
	...
	if modelPrice and xPlayer.getMoney() >= modelPrice then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', { type = 'inform', text = _U('vip_belongs', plate )})
