...
ESX.RegisterUsableItem('bandage', function(source)
	...
	if Config.Removeables.Bandage then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_bandage') })
...
AddEventHandler('esx_extraitems:givebandages', function()
	...
	if xPlayer.canCarryItem(itemName, amount) then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_firstaidkit') })
		--xPlayer.showNotification(_U('used_firstaidkit'))
		xPlayer.addInventoryItem(itemName, amount)
	else
	TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('player_cannot_hold', 'Bandages') })
...
ESX.RegisterUsableItem('bulletproof', function(source)
	...
	if Config.Removeables.BulletProofVest then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_bulletproof') })
...
AddEventHandler('esx_extraitems:removedefib', function()
	...
	if Config.Removeables.Defib then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_defib') })
...
AddEventHandler('esx_extraitems:removedrill', function()
	...
	if Config.Removeables.Drill then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_drill') })
...
ESX.RegisterUsableItem('firework', function(source)
	...
	if Config.Removeables.Firework then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_firework') })
...
AddEventHandler('esx_extraitems:removelockpick', function()
	...
	if Config.Removeables.LockPick then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_lockpick') })
...
ESX.RegisterUsableItem('oxygenmask', function(source)
	...
	if Config.Removeables.OxygenMask then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_oxygenmask') })
...
AddEventHandler('esx_extraitems:removerepairkit', function()
	...
	if Config.Removeables.RepairKit then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_repairkit') })
...
AddEventHandler('esx_extraitems:removetirekit', function()
	...
	if Config.Removeables.TireKit then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_tirekit') })
...
AddEventHandler('esx_extraitems:removeweakit', function()
	...
	if Config.Removeables.WeaKit then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('used_weakit') })
