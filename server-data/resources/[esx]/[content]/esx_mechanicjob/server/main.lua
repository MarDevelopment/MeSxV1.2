...
local function Harvest(source)
	SetTimeout(4000, function()
		...
		if PlayersHarvesting[source] == true then
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_do_not_room') })
...
AddEventHandler('esx_mechanicjob:startHarvest', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('recovery_gas_can') })
...
AddEventHandler('esx_mechanicjob:startHarvest2', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('recovery_repair_tools') })
...
AddEventHandler('esx_mechanicjob:startHarvest3', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('recovery_body_tools') })
...
local function Craft(source)
	SetTimeout(4000, function()
		...
		if PlayersCrafting[source] == true then
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('not_enough_gas_can') })
...
AddEventHandler('esx_mechanicjob:startCraft', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('assembling_blowtorch') })
...
local function Craft2(source)
	SetTimeout(4000, function()
		...
		if PlayersCrafting2[source] == true then
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('not_enough_repair_tools') })
...
AddEventHandler('esx_mechanicjob:startCraft2', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('assembling_repair_kit') })
...
local function Craft3(source)
	SetTimeout(4000, function()
		...
		if PlayersCrafting3[source] == true then
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('not_enough_body_tools') })
...
AddEventHandler('esx_mechanicjob:startCraft3', function()
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('assembling_body_kit') })
...
TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('your_comp_earned') })
...
ESX.RegisterUsableItem('blowpipe', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_used_blowtorch') })
...
ESX.RegisterUsableItem('fixkit', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_used_repair_kit') })
...
ESX.RegisterUsableItem('carokit', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('you_used_body_kit') })
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_mechanic', function(inventory)
		...
		if count > 0 and item.count >= count then
			...
			if xPlayer.canCarryItem(itemName, count) then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('have_withdrawn', count, item.label) })
				--xPlayer.showNotification(_U('have_withdrawn', count, item.label))
			else
			TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('player_cannot_hold') })
				--xPlayer.showNotification(_U('player_cannot_hold'))
			end
		else
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('invalid_quantity') })
...
TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('have_deposited', count, item.label) })
