		...
		elseif data.current.value == 'fix_vehicle' then
			...
			if DoesEntityExist(vehicle) then
				...
				Citizen.CreateThread(function()
					...
					ClearPedTasksImmediately(playerPed)
					exports['mythic_notify']:SendAlert('Inform', _U('vehicle_repaired'))
		...
		elseif data.current.value == 'clean_vehicle' then
			...
			if DoesEntityExist(vehicle) then
				...
				Citizen.CreateThread(function()
					...
					ClearPedTasksImmediately(playerPed)	
				exports['mythic_notify']:SendAlert('Inform', _U('vehicle_cleaned'))
	...
	if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 5.0) then
		...
		if DoesEntityExist(vehicle) then
			...
			Citizen.CreateThread(function()
				...
				SetVehicleDeformationFixed(vehicle)
				ClearPedTasksImmediately(playerPed)
				exports['mythic_notify']:SendAlert('Inform', _U('body_repaired'))
	...
	if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 5.0) then
		...
		if DoesEntityExist(vehicle) then
			...
			Citizen.CreateThread(function()
				...
				SetVehicleUndriveable(vehicle, false)
				ClearPedTasksImmediately(playerPed)
				exports['mythic_notify']:SendAlert('Inform', _U('veh_repaired'))
