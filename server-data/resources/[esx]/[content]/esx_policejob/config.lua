...
Config.MaxInService               = 20 -- How much people can be in service at once (0 equals no limit)?

Config.DisableHandcuffsMove        = true -- true slår gå + kamara funktioner til false gør det modsat
