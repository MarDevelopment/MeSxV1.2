	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		if data.current.value == 'citizen_interaction' then
			local elements = {
				...
				{label = "Samfundstjæneste",	value = 'communityservice'}
			}
		...
		elseif data.current.value == 'vehicle_interaction' then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_interaction', {
				...
				exports['mythic_notify']:SendAlert('Inform', _U('no_vehicles_nearby'))
...
function LookupVehicle()
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'lookup_vehicle', {
		...
		exports['mythic_notify']:SendAlert('Inform', _U('search_database_error_invalid'))
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_buy_weapons_components', {
		...
		exports['mythic_notify']:SendAlert('Inform', _U('armory_hascomponent'))
			...
			ESX.TriggerServerCallback('esx_policejob:buyWeapon', function(bought)
				if bought then
					if data.current.price > 0 then
					exports['mythic_notify']:SendAlert('Inform', _U('armory_bought', data.current.componentLabel, ESX.Math.GroupDigits(data.current.price)))
	...
	ESX.TriggerServerCallback('esx_policejob:getStockItems', function(items)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if not count then
				exports['mythic_notify']:SendAlert('Inform', _U('quantity_invalid'))
...
Citizen.CreateThread(function()
	while true do
		...
		if Config.DisableHandcuffsMove and isHandcuffed then	
...
Citizen.CreateThread(function()
	while true do
		...
		exports['mythic_notify']:SendAlert('Inform', _U('impound_canceled'))
...
function ImpoundVehicle(vehicle)
	...
	exports['mythic_notify']:SendAlert('Inform', _U('impound_successful'))
...
function SendToCommunityService(player)
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'Community Service Menu', {
		title = "Samfundstjæneste menu",
	}, function (data2, menu)
		local community_services_count = tonumber(data2.value)
		
		if community_services_count == nil then
		exports['mythic_notify']:SendAlert('Inform', 'Ugyldig service mængde')
			ESX.ShowNotification('Ugyldig service mængde.')
		else
