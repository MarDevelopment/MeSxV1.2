...
AddEventHandler('esx_policejob:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	if itemType == 'item_standard' then
		...
		if targetItem.count > 0 and targetItem.count <= amount then
			...
			if sourceXPlayer.canCarryItem(itemName, sourceItem.count) then
				...
				TriggerClientEvent('mythic_notify:client:SendAlert', sourceXPlayer, { type = 'inform', text = _U('you_confiscated', amount, sourceItem.label, targetXPlayer.name) })
				--sourceXPlayer.showNotification(_U('you_confiscated', amount, sourceItem.label, targetXPlayer.name))
				TriggerClientEvent('mythic_notify:client:SendAlert', targetXPlayer, { type = 'inform', text = _U('got_confiscated', amount, sourceItem.label, sourceXPlayer.name) })
				--targetXPlayer.showNotification(_U('got_confiscated', amount, sourceItem.label, sourceXPlayer.name))
			else
			TriggerClientEvent('mythic_notify:client:SendAlert', sourceXPlayer, { type = 'inform', text = _U('quantity_invalid') })
	...
	elseif itemType == 'item_account' then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', sourceXPlayer, { type = 'inform', text = _U('you_confiscated_account', amount, itemName, targetXPlayer.name) })
		--sourceXPlayer.showNotification(_U('you_confiscated_account', amount, itemName, targetXPlayer.name
		TriggerClientEvent('mythic_notify:client:SendAlert', targetXPlayer, { type = 'inform', text = _U('you_confiscated_account', amount, itemName, targetXPlayer.name) })
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', sourceXPlayer, { type = 'inform', text = _U('you_confiscated_weapon', ESX.GetWeaponLabel(itemName), targetXPlayer.name, amount) })
		--sourceXPlayer.showNotification(_U('you_confiscated_weapon', ESX.GetWeaponLabel(itemName), targetXPlayer.name, amount))
	TriggerClientEvent('mythic_notify:client:SendAlert', targetXPlayer, { type = 'inform', text = _U('got_confiscated_weapon', ESX.GetWeaponLabel(itemName), amount, sourceXPlayer.name) })	
...
AddEventHandler('esx_policejob:getStockItem', function(itemName, count)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_police', function(inventory)
		...
		if count > 0 and inventoryItem.count >= count then
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('quantity_invalid') })
...
AddEventHandler('esx_policejob:putStockItems', function(itemName, count)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_police', function(inventory)
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U('have_deposited', count, inventoryItem.label) })
...
ESX.RegisterServerCallback('esx_policejob:getOtherPlayerData', function(source, cb, target, notify)
	...
	if notify then
	TriggerClientEvent('mythic_notify:client:SendAlert', xPlayer, { type = 'inform', text = _U(being_searched) })
