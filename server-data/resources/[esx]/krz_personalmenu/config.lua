...
-- GPS --
Config.GPS = {
	{label = 'Ingen', coords = nil},
	{label = 'Politi midtby', coords = vector2(425.13, -979.55)},
	{label = 'Garage midtby', coords = vector2(-449.67, -340.83)},
	{label = 'Hospitalet', coords = vector2(-33.88, -1102.37)},
	{label = 'Forhandler', coords = vector2(215.06, -791.56)},
	{label = 'Benny\'s Custom', coords = vector2(-212.13, -1325.27)},
	{label = 'Job center', coords = vector2(-264.83, -964.54)},
	{label = 'Køreskole', coords = vector2(-829.22, -696.99)},
